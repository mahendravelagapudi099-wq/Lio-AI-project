#!/usr/bin/env python3
"""Basic functionality test for LEO AI Assistant"""
...
def test_system_imports():
    ...
    try:
        ...
        print("✓ InterfaceRouter imported successfully")
    except Exception as e:
        print(f"✗ InterfaceRouter failed: {e}")
        return False
...
def test_safety_system():
    ...
    for cmd in test_commands:
        try:
            ...
            status = "✓" if assessment.is_allowed else "✗"
